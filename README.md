...
(notably [ormsgpack](https://github.com/ormsgpack/ormsgpack) and [msgpack](https://github.com/msgpack/msgpack-python/))
but they never worked for one reason or another. I then asked some LLM's to decode the
metadata just to see what they would say, and they said that the MessagePack format that was 
used to encode the metadata was heavily altered.
